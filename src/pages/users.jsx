...
const User = ({ e, i, getUsers, edit }) => {
  ...
  return (
    <div className="col-lg-4 col-md-6" key={i}>
      <div className="room-card border ">
        <div className="room-header">
          <h2 className="room-heading">{e.userName}</h2>
        </div>
        ...
        <p className="mt-0 room-description">Ponits: {e.points}</p>
      ...
      <section id="room">
        <div className="custome-container mt-20">
          <div className="text-right add-btn">
            <div className="section-title">Users  <button onClick={addFun}>Add</button></div>
          </div>
          {loading ? (
            <Loading />
            ...
            <div className="row">
              {users.map((e, i) => {
                return <User e={e} i={i} getUsers={getUsers}
                  edit={(u => {
                    setSelUser(u)
                    setAdd(true)
                  })} />
